...
public class CalculateAlertDialogFragment extends DialogFragment implements DialogInterface.OnClickListener {



    public static CalculateAlertDialogFragment newInstance(String message) 	{
        CalculateAlertDialogFragment adf = new CalculateAlertDialogFragment();
    ...
    public void onAttach(Activity act) {
        ...
        try {
            ...
            Log.e(CalculatePowerFragment.LOGTAG, "Activity is not listening");
        }
        super.onAttach(act);
    }
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        act.onDialogDone(getTag(), cancelled, "Calculation Result dismissed");
    }
}
